const Vector1Introduction = props => {

    const externalClass = props.className

    return (
        <svg className={externalClass} xmlns="http://www.w3.org/2000/svg" width="1440" height="262" viewBox="0 0 1440 262" fill="none">
...
export default Vector1Introduction